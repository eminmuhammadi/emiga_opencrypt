    ...
    <div class="form-signin">
      ...
      <div class="form-group">
       ...
       <button style="margin-top:-16.5px;background-color:grey;color:white;" 
       	onclick="copy_text();" type="button" class="btn btn-sm btn-secondary btn-block">Kopyala</button></br> 
		<script>
		function copy_text() {
      ...
      <button  onclick="window.history.go(-1); return false;" class="btn btn-lg btn-primary btn-block" type="submit">Geriyə dön</button>
      <p class="mt-5 mb-3 text-muted text-center">&copy;<?php echo date("Y");?> EmiGa <a href="https://github.com/eminmuhemmedi/opencrypt_emiga/">Proyektə bax</a></br> <a href="/app/en/">English</a> | <a href="/app/ru/">Русский</a> | <a href="/app/az/">Azərbaycanca</a></p>
    </div>
