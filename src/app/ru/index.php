...
<html hreflang="ru" lang="ru">
  <head>
    ...
    <title>Легко шифровать и расшифровывать любую текст | OpenCrypt</title>
    <link rel="canonical" href="<?php echo $url ;?>" />
    <meta name="description" content="С помощью инструмента OpenCrypt вы можете легко шифровать и расшифровывать любую текст ">
    ...
    <meta name="twitter:description" content="С помощью инструмента OpenCrypt вы можете легко шифровать и расшифровывать любую текст">
  ...
  if(!is_string($_GET['type'])){
        ...
        function error_log() {  
        alert(\"Вы не можете сделать это \");}</script>"; 
  require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/app/ru/calculator.php'); 
  }
  ...
  else {require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/app/ru/result.php');}
  }
  else
  { 
